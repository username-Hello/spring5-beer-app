create table beer (id bigint not null auto_increment, name varchar(255), beer_type_id bigint, description_id bigint, snack_id bigint, primary key (id)) engine=InnoDB;
create table beer_fan (beer_id bigint not null, fan_id bigint not null) engine=InnoDB;
create table beer_type (id bigint not null auto_increment, description varchar(255), primary key (id)) engine=InnoDB;
create table description (id bigint not null auto_increment, text longtext, beer_id bigint, primary key (id)) engine=InnoDB;
create table fan (id bigint not null auto_increment, first_name varchar(255), last_name varchar(255), sex integer, review_id bigint, primary key (id)) engine=InnoDB;
create table ingredient (id bigint not null auto_increment, description varchar(255), beer_id bigint, primary key (id)) engine=InnoDB;
create table review (id bigint not null auto_increment, text longtext, beer_id bigint, fan_id bigint, primary key (id)) engine=InnoDB;
create table snack (id bigint not null auto_increment, description varchar(255), type integer, primary key (id)) engine=InnoDB;
